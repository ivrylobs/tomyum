...
Route::group(['middleware' => ['storefront'], 'namespace' => 'Storefront'], function(){
   ...
   // Auth route for customers
    ...
    Route::get('shop-list', 'ShopListController@index')->name('shop.index');
    Route::get('shop-list/{slug}', 'ShopListController@listView')->name('shop.list');
    Route::get('shop-view/{slug}', 'ShopListController@show')->name('shop.view');
});
