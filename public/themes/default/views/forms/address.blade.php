...
<div class="form-group">
    {!! Form::text('info_email', Null, ['class' => 'form-control flat', 'placeholder' => 'Email']) !!}
</div>
<div class="form-group">
    {!! Form::text('info_fax', Null, ['class' => 'form-control flat', 'placeholder' => 'Fax']) !!}
</div>
<div class="form-group">
    {!! Form::text('info_alt_email', Null, ['class' => 'form-control flat', 'placeholder' => 'Alternative Email']) !!}
</div>
<div class="form-group">
    {!! Form::text('info_phone', Null, ['class' => 'form-control flat', 'placeholder' => 'Phone']) !!}
</div>
<div class="form-group">
    {!! Form::text('info_social_link', Null, ['class' => 'form-control flat', 'placeholder' => 'Social Link']) !!}
</div>
<div class="form-group">
    {!! Form::text('info_mobile', Null, ['class' => 'form-control flat', 'placeholder' => 'Mobile']) !!}
</div>