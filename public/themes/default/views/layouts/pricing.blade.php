<div class="product-info-price">
    ...
    <span class="product-info-price-new text-right" data-price="{{ $item->currnt_sale_price() }}">{!! get_formated_price($item->currnt_sale_price(), 0) !!}</span>
...
{{--        @endforeach--}}
    ...
    @php
    // echo "Munna: " .  get_formated_price(15.35, 2);
    @endphp
