...
{{--                        </a>--}}
                        ...
                        <img src="{{ get_storage_file_url($wish->product->shop['image']['path'], 'small') }}" class="seller-info-logo img-sm img-responsive" alt="{{ trans('theme.logo') }}">
                    </div>
                    ...
                    <div class="product-info">
                        ...
                        <div class="merchant-name">
                            <h4>
                                <span>Merchant: </span>
                                <a href="{{ url('shop', $wish->product->shop['slug']) }}" class="btn-link">
                                    {{ $wish->product->shop['name'] }}
                                </a>
                            </h4>
                        </div>
                    </div><!-- /.product-info -->
