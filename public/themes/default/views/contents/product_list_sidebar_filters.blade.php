...
{{--        </div>--}}
    ...
    {{-- price --}}
    <div class="category-filters-section">
        <h2 class="text-uppercase c-grey">Search Filter
            @if(Request::has('price'))
                <a href="#" data-name="price" class="clear-filter small text-capitalize pull-right">@lang('theme.button.clear')</a>
            @endif
        </h2>

        <div class="space20"></div>
        <h5 class="text-capitalize c-grey">Price Range</h5>
        <div class="space20"></div>

        <span class="col-md-5 nopadding-left c-grey">Min</span>
        <span class="col-md-2"></span>
        <span class="col-md-5 nopadding-left c-grey">Max</span>

        <input class="col-md-5 text-right nopadding-right" type="text">
        <span class="col-md-2 text-center"></span>
        <input class="col-md-5 text-right nopadding-right" type="text">

        <div class="row" style="width:98%; margin:80px auto">
