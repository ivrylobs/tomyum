    ...
    */
    ...
    public function login(Request $request)
    {
      $this->validate($request, [
        ...
        $customer = Customer::where('email', trim($request->email))->first();

        if ( !$customer){
//            redirect()->intended(url()->previous())->with('error', trans('theme.notify.login_not_found_email'));
            return $this->sendFailedLoginResponseNotFoundEmail($request);
        }
